...
import { Box, HStack, Heading, Button, useColorModeValue, IconButton, Tooltip } from '@chakra-ui/react'
      ...
      <Box bg={headerBg} borderBottom="1px" borderColor={borderColor}>
        <Box maxW="1200px" mx="auto" px={6} py={4}>
          <HStack justify="space-between">
            <HStack spacing={4}>
              <Heading size="md" color={textColor}>Author Panel</Heading>
              <Link to="/authors/posts">
                <Button variant="ghost" size="sm" color={textColor}>
                  Posts
                </Button>
              </Link>
              <Link to="/authors/drafts">
                <Button variant="ghost" size="sm" color={textColor}>
                  Drafts
                </Button>
              </Link>
              <Link to="/authors/tags">
                <Button variant="ghost" size="sm" color={textColor}>
                  Tags
                </Button>
              </Link>
